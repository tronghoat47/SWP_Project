...
public class RestaurantService {
    ...
    public List<Restaurant> searchRestaurant(Company company, String city, String restaurantName) {
        if(company != null)
            return restaurantRepo.findRestaurantsByCompanyAndCityContainingIgnoreCaseAndAndResNameContainingIgnoreCase(company, city, restaurantName);
        else
            return restaurantRepo.findRestaurantsByCityContainingIgnoreCaseAndAndResNameContainingIgnoreCase(city, restaurantName);
    }
